...
import bgImage from "../../assets/images/backgrounds/slide-1.webp";
import HeartImage from "../../assets/images/shapes/heart-2-1.png";

const CallToActionTwo = ({heading,title,btntext,link}) => {
  return (
        ...
        <Row className=" align-items-center">
          ...
          >
            <div className="btn-wrap">
              <Link href={link}>
                <a className="scroll-to-target thm-btn">{btntext}</a>
              </Link>
            </div>
          </Col>
        </Row>
